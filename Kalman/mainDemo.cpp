...
int main()
{
	...
	////////////////////////////////////////
	std::string sequence = "D:/QQdocuments/2214835005/FileRecv/detection/detection/data/test0";    //读取txt文件，每个文件包含一帧所有的检测框
	std::string video_path = "D:/QQdocuments/2214835005/FileRecv/detection/detection/data/test0.AVI";   //读取视频
